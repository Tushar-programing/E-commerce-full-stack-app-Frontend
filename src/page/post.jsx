...
function Post() {
  ...
  return (
    <div className='sm:ml-20 md:ml-10 xl:ml-36 2xl:ml-72 sm:mr-20 md:mr-10 xl:mr-28 2xl:mr-56'>
      ...
      <div
        className=" h-[620px] sm:h-[730px] md:h-[780px] col-span-12 md:col-span-6 bg-white md:sticky top-10 shadow-none sm:shadow-none md:shadow-[1px_1px_10px_rgba(0,0,0,0.1)]"
      >
          ...
          {/* <div className='text-center border flex justify-center py-1'>
            {post?.image?.map((img, index) => <div key={index} className={`bg-gray-200 rounded-xl w-3 h-3 ${brd === index && 'outline mx-1 outline-gray-400 h-3'}`}></div>)}
          </div> */}
        ...
        <div className="col-span-12 md:col-span-6 px-10">
          ...
          <div className=' mt-8 grid grid-cols-12 gap-3'>
            <button onClick={onClick} className='col-span-12 lg:col-span-6 border bg-gray-900 text-white py-3 flex justify-center'><IoBagCheckOutline className=' my- me-3 w-5 h-5' />ADD TO BAG</button>
            <button onClick={checkActive} className='col-span-12 lg:col-span-4 border-gray-900 py-3 border-2 font-semibold flex justify-center'><BiPurchaseTag className=' my-auto me-3 w-5 h-5' />BUY NOW</button>
          </div>
